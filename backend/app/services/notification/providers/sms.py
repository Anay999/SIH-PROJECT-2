...
class MSG91SMSProvider(BaseNotificationProvider):
    ...
    def validate_configuration(self) -> Dict[str, Any]:
        ...
        configured = has_msg91 or has_fast2sms

        active_provider = self.provider_name if has_msg91 else ("FAST2SMS_INDIA" if has_fast2sms else self.provider_name)
    ...
    async def send_message(
        ...
        # 2. LIVE MODE: MSG91 SMS Gateway (Primary Indian DLT provider)
        ...
        return ProviderResult(
            ...
            error_message="SMS gateway credentials missing. Please set MSG91_AUTH_KEY & MSG91_FLOW_ID (or FAST2SMS_API_KEY) in backend/.env.",
            is_simulated=False,
            is_retryable=False
        )
